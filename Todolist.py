...
class ToDoList:
    def __init__(self):#initlise the code
        self.tasks = []

#defined a new function add_task
    def add_task(self, task):
        self.tasks.append(task)#addtion of task 
        print("Task were added : ",task)
#defined a new function remove_task
    ...
    #define a functon to display data 
    def display(self):
        if not self.tasks:
...
#defined a new function which is main
def main():
    todo_list = ToDoList()
